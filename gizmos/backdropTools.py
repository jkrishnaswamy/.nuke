...
def addStandardShortcuts():
    ...
    '''
    m = nuke.menu('Nuke')
    m.addCommand("Edit/Backdrops/Fix Layering", "backdropTools.fixBackdropDepth()", "Ctrl+Shift+A")
    m.addCommand("Edit/Backdrops/Shift Hue", "backdropTools.shiftBackdropHue()", "Shift+H")
    m.addCommand("Edit/Backdrops/Spread Hues", "backdropTools.spreadBackdropHues()", "Alt+Shift+H")
    m.addCommand("Edit/Backdrops/Luma +", "backdropTools.shiftBackdropLuma(step = 0.1)", "Shift+>")
    m.addCommand("Edit/Backdrops/Luma -", "backdropTools.shiftBackdropLuma(step = -0.1)", "Shift+<")
    m.addCommand("Edit/Backdrops/Sat +", "backdropTools.shiftBackdropSat(step = 0.1)", "Alt+.")
    m.addCommand("Edit/Backdrops/Sat -", "backdropTools.shiftBackdropSat(step = -0.1)", "Alt+,")